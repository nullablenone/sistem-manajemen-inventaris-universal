    ...
    <div class="max-w-2xl mx-auto mt-6">
        ...
        <div class="card shadow-md">
            <div class="card-header">
                ...
                <p class="text-xs text-gray-500 mt-1">Add a new category classification for your products</p>
            </div>
            ...
            <div class="card-body">
                <form action="{{ route('categories.store') }}" method="POST" id="createCategoryForm">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-xs text-gray-400 mt-1">Unique URL-friendly identifier, generated automatically from the name.</p>
                        @error('slug')
                            <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span>
                        @enderror
                    </div>
