...
@section('content')
    <div class="max-w-2xl mx-auto my-8">
        ...
        <div class="card shadow-md border border-gray-250 bg-white rounded-lg">
            ...
            <div class="card-body p-6">
                <form action="{{ route('attributes.store') }}" method="POST" id="createAttributeForm">
                    @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Load values from old input if validation failed previously
            ...
            // Re-render UI with preloaded or current values
            renderTags();
